...
#ifdef RT_CAN_USING_HDR
#define RT_CAN_FILTER_ITEM_INIT(id,ide,rtr,mode,mask,hdr,ind,args) \
     {(id), (ide), (rtr), (mode), (mask), (hdr), (ind), (args)}
#define RT_CAN_FILTER_STD_INIT(id,hdr,ind,args) \
     RT_CAN_FILTER_ITEM_INIT(id,0,0,1,0x00000000,hdr,ind,args)
#define RT_CAN_FILTER_EXT_INIT(id,hdr,ind,args) \
     RT_CAN_FILTER_ITEM_INIT(id,1,0,1,0x00000000,hdr,ind,args)
#define RT_CAN_STD_RMT_FILTER_INIT(id,hdr,ind,args) \
     RT_CAN_FILTER_ITEM_INIT(id,0,1,1,0x00000000,hdr,ind,args)
#define RT_CAN_EXT_RMT_FILTER_INIT(id,hdr,ind,args) \
     RT_CAN_FILTER_ITEM_INIT(id,1,1,1,0x00000000,hdr,ind,args)
#define RT_CAN_STD_RMT_DATA_FILTER_INIT(id,hdr,ind,args) \
     RT_CAN_FILTER_ITEM_INIT(id,0,0,1,0x00000000,hdr,ind,args)
#define RT_CAN_EXT_RMT_DATA_FILTER_INIT(id,hdr,ind,args) \
     RT_CAN_FILTER_ITEM_INIT(id,1,0,1,0x00000000,hdr,ind,args)
#else
